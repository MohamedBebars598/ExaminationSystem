...
namespace login
{
    ...
    public partial class examEntities1 : DbContext
    {
        ...
        public virtual ObjectResult<string> InsertCourseTwo(Nullable<int> crsID, string crsName, string crsDesc, Nullable<int> crsDur)
        {
            var crsIDParameter = crsID.HasValue ?
                new ObjectParameter("CrsID", crsID) :
                new ObjectParameter("CrsID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("InsertCourseTwo", crsIDParameter, crsNameParameter, crsDescParameter, crsDurParameter);
        }
    }
}
